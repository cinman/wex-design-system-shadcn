...
const listboxVariants = cva(
  "w-full rounded-md border bg-background text-sm shadow-sm transition-colors",
  {
    variants: {
      invalid: {
...
interface ListboxHeaderProps extends React.HTMLAttributes<HTMLDivElement> {}
...
interface ListboxSelectAllProps extends React.HTMLAttributes<HTMLDivElement> {
...
function ListboxSelectAll({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-2 px-3 py-2 border-b cursor-pointer hover:bg-accent/50 transition-colors",
    ...
    >
      <div
        className={cn(
          ...
          checkboxState === true && "bg-primary text-primary-foreground",
          checkboxState === "indeterminate" && "bg-primary text-primary-foreground"
        )}
      >
...
interface ListboxOptionsProps extends React.HTMLAttributes<HTMLUListElement> {
  /** Accessible label */
  "aria-label"?: string
  /** ID of element that labels this listbox */
  "aria-labelledby"?: string
...
interface ListboxOptionProps extends React.HTMLAttributes<HTMLLIElement> {
...
interface ListboxGroupProps extends React.HTMLAttributes<HTMLLIElement> {
  /** Group label */
  label: string
}
...
interface ListboxEmptyProps extends React.HTMLAttributes<HTMLDivElement> {}
...
/**
 * Listbox - A list selection component with full accessibility support
 *
 * Features:
 * - Roving tabindex for proper focus management (focus goes to options, not container)
 ...
 * <Listbox options={cities} value={selected} onValueChange={setSelected}>
 *   <Listbox.Options />
 * </Listbox>
 *
 * @example
 ...
 *   </Listbox.Header>
 *   <Listbox.Options />
 *   <Listbox.Empty>No cities found</Listbox.Empty>
 * </Listbox>
 *
 * @example
 * // Manual options (note: click or Tab into an option to start navigation)
 * <Listbox value={selected} onValueChange={setSelected}>
 *   <Listbox.Options>
 *     <Listbox.Option uKey="NY">New York</Listbox.Option>
 *     <Listbox.Option uKey="LA">Los Angeles</Listbox.Option>
 *   </Listbox.Options>
 * </Listbox>
 */
