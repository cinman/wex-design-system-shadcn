      ...
      switch (display) {
        case "chips": {
          ...
          const chipClasses = floatLabel
            ? "inline-flex items-center gap-1 bg-primary text-primary-foreground text-xs px-2 py-0 rounded-full shrink-0"
            : "inline-flex items-center gap-1 bg-primary text-primary-foreground text-xs px-2 py-0.5 rounded-full shrink-0"
          ...
          const removeButtonClasses = floatLabel
            ? "inline-flex items-center justify-center rounded-full hover:bg-primary-foreground/20 -mr-1 cursor-pointer min-h-5 min-w-5"
            : "inline-flex items-center justify-center rounded-full hover:bg-primary-foreground/20 -mr-1 cursor-pointer min-h-6 min-w-6"
            ...
            >
              <div
                className={cn(
                  ...
                  (allSelected || someSelected) ? "bg-primary text-primary-foreground" : "bg-background"
                )}
              >
  ...
  return (
    <li
      ...
      className={cn(
        ...
        isFocused && !isKeyboardFocus && !isSelected && "bg-accent/50",
        isFocused && !isKeyboardFocus && isSelected && "bg-primary/25"
      )}
