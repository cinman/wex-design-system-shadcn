...
const componentParity = [
  ...
  { category: "Form", wex: "InputNumber", primeng: "InputNumber", status: "complete", notes: "Sizes, currency, prefix/suffix, buttons" },
  { category: "Form", wex: "InputMask", primeng: "InputMask", status: "complete", notes: "Mask patterns, autoClear, float label" },
  { category: "Form", wex: "Listbox", primeng: "Listbox", status: "complete", notes: "Single/multi select, filter, checkbox, groups" },
  { category: "Form", wex: "MultiSelect", primeng: "MultiSelect", status: "complete", notes: "Comma/chips modes, filter, select all" },
